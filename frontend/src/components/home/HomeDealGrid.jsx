      ...
      {items.map((item) => (
        ...
        >
          <div className="space-y-2 sm:space-y-3">
            <div className="text-[10px] font-semibold uppercase tracking-[0.18em] text-brand-dark/80 sm:text-xs sm:tracking-[0.22em]">{item.eyebrow}</div>
            <div>
            ...
            <div className="inline-flex items-center gap-2 text-xs font-semibold text-brand transition group-hover:translate-x-1 sm:text-sm">
              Shop now
