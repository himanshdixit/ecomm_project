export default function AdminSectionCard({ title, description, action, children, className = "" }) {
  return (
    <section
      className={`relative min-w-0 overflow-hidden rounded-[30px] border border-white/75 bg-white/92 p-4 shadow-[0_26px_70px_rgba(15,23,42,0.06)] backdrop-blur-sm sm:p-6 ${className}`.trim()}
    >
